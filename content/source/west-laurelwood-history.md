...
> MERGE these sections into content/source/west-laurelwood.md (add what is missing; do not delete existing intro/birth-of sections).

## 1960s-1970s: The Growth of East and West Laurelwood

[Section heading present in source; if body copy for this section exists in the current west-laurelwood.md or development-history.md, keep it there. Otherwise this heading anchors the growth-era band using the existing ported copy.]

## A Glimpse into West Laurelwood's Early Development on the Big Screen
...
[VIDEO: the clip file Orderly_V3E (1).mp4 belongs in this section, gold-framed player, caption: "West Laurelwood, mid-construction, as seen in The Disorderly Orderly (1964)."]

## 1978-1980: Preservation Efforts and Wilacre Park
...
## Cultural Legacy in Street Names

[Section heading present in source; the Doña street-names copy already in west-laurelwood.md / dona-streets.md belongs under this theme. Keep the /dona-streets page as the deep treatment and let this band link to it.]

## West Laurelwood Today
