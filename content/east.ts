// content/east.ts
// Band copy for the /east-laurelwood page. VERBATIM from
// content/source/east-wix-extraction.md (the Wix extraction). ZERO text
// changes: straight quotes as-extracted, the single em dash in the Real
// Estate Ads section preserved, "Doña" with the ñ. The duplicate "real estate
// ads ... window" paragraph is kept ONCE here (Real Estate Ads opener) and
// omitted under Embrace, per Jack's decision. No eyebrows: the extraction has
// no eyebrow text, so sections render heading + gold-rule only.

export const eastContent = {
  hero: {
    title: "EAST LAURELWOOD",
    subtitle: "History of East Laurelwood",
  },

  // ## SECTION: Introduction to East Laurelwood
  intro: {
    heading: "Introduction to East Laurelwood",
    body: [
  ...
  vision: {
    heading: "The Vision of East Laurelwood (1960s)",
    realtyCaption: "April 13, 1966 E Laurelwood Advertisment",
    body: [
      "At Misraje Real Estate Partners, we believe that to be a top real estate agent, you need to know your product inside and out. When it comes to East Laurelwood, we certainly do. As residents and specialists in the area, we've studied its rich history, seen its development firsthand, and understand the unique appeal that continues to make it one of the most desirable neighborhoods in the Valley.",
      ...
      "The homes, priced between $18,000 and $25,000 at the time, were a rare opportunity for buyers to secure a prime property with panoramic views. Each house was custom-built with spacious layouts and cutting-edge features for the era, including built-in appliances, expansive windows, and ample room for landscaping. East Laurelwood quickly developed into a coveted area where families could thrive in a peaceful, well-connected neighborhood.",
  ...
  growth: {
    heading: "Growth and Expansion of East Laurelwood",
    kidsCaption:
      "Kids in the early 70s are lined up in Laurelwood, waiting for the school bus to arrive.",
    busCaption: "Laurelwood kids in the early 70s on the neighborhood bus to school.",
    body: [
  ...
  // body[0] is the duplicate "window" paragraph, kept ONCE here.
  ads: {
    heading: "Real Estate Ads: A Glimpse into the Past",
    naturesCaption:
    ...
    body: [
      ...
      "Initially, lots in East Laurelwood were sold at prices ranging from $18,000 to $25,000, giving prospective homeowners the opportunity to build custom homes on spacious, elevated sites. These lots offered plenty of room for both construction and landscaping, but it was the homes themselves that drew the most attention. The custom-built houses were priced higher, often ranging from $47,000 to $66,000, depending on features such as panoramic views, swimming pools, and large family rooms. One ad even included a free car, a brand-new 1965 compact car, with the purchase of a home, showcasing the competitive and creative spirit of the real estate market at the time.",
  ...
  // ## SECTION: Embrace the East Laurelwood Lifestyle (duplicate paragraph omitted)
  embrace: {
    heading: "Embrace the East Laurelwood Lifestyle",
    body: [
      ...
      "Explore East Laurelwood today. When you're ready to take the next step, whether buying or selling, contact us at Misraje Real Estate Partners. We're here to help you find your place in this wonderful community.",
  ...
  preservation: {
    heading: "Preservation and Modern Day East Laurelwood",
    body: [
      ...
      "One of the most striking features of East Laurelwood is its architectural preservation. Many original homes remain, showcasing the thoughtful design elements of the time, such as sprawling floor plans, large windows that frame panoramic views, and a seamless connection between indoor and outdoor living spaces. These homes retain the character and craftsmanship of their era, with modern renovations often enhancing rather than replacing these timeless features. Homeowners who appreciate the history of the neighborhood have been careful to update with respect to its original architectural vision, maintaining the blend of comfort and luxury that has always defined East Laurelwood.",
      "However, the area hasn't been frozen in time. As new families move in, many properties have been reimagined with state-of-the-art amenities, energy-efficient upgrades, and modern design elements that fit seamlessly into the neighborhood's unique hillside landscape. These newer homes provide contemporary comforts while still respecting the area's history and aesthetic. The result is a community that offers the best of both worlds: preserved architectural gems alongside cutting-edge modern homes.",
  ...
  today: {
    ...
    body: [
      ...
      "East Laurelwood's residents enjoy easy access to both natural beauty and urban convenience. Nestled in the hills, the neighborhood offers a sense of tranquility and privacy, yet it is only a short drive to the shops, restaurants, and entertainment options in Studio City and Hollywood. With its close proximity to Laurel Canyon Boulevard and major freeways, residents can enjoy the best of both worlds: a peaceful home life and quick access to the heart of Los Angeles.",
  ...
  freeway: {
    heading: "The Laurel Canyon Freeway Controversy",
    mapCaption:
    ...
    body: [
      "In the 1970s, East Laurelwood faced a significant challenge that threatened its peaceful atmosphere and scenic charm. The proposed construction of the Laurel Canyon Freeway was set to cut through the Santa Monica Mountains, linking the San Fernando Valley with Los Angeles International Airport. The planned route would have passed through key areas of East and West Laurelwood, altering the neighborhood landscape and affecting property values. The controversy surrounding this project brought together residents of East Laurelwood, West Laurelwood, and nearby communities in a united effort to preserve their way of life.",
