// content/land-acquisition.ts
// Band copy for /history/land-acquisition. VERBATIM from
...
export const landAcquisitionContent = {
  hero: {
    title: "Acquiring Laurelwood: A Mid-Century Development",
  },

  // ## Development of West Laurelwood (1958) / A Mid-Century Suburban Gem
  west: {
    eyebrow: "A Mid-Century Suburban Gem",
    heading: "Development of West Laurelwood (1958)",
    body: [
  ...
  homeowners: {
    heading: "For Homeowners : Preserving the Cultural and Architectural Legacy",
    body: [
