...
export const metadata = {
  ...
  description:
    "Weekly Los Angeles real estate analysis from Karen and Jack Misraje. Market trends, pricing, and commentary across the LA region and the San Fernando Valley.",
        ...
        <section className="bg-white py-20 md:py-28">
          <div className="editorial">
            <p className="text-base text-stone-600 italic">
              The next report will be published shortly. Please check back soon.
            </p>
          </div>
        </section>
      </>
          ...
          <div className="grid md:grid-cols-4 gap-12 md:gap-16">
            ...
            <article className="md:col-span-3">
              <p className="text-[11px] font-medium text-gold-500 mb-3" style={{ letterSpacing: "0.18em" }}>
                LATEST &middot; {formatReportDate(latest.publish_date).toUpperCase()}
              </p>
              <div
              ...
              <div className="md:sticky md:top-32">
                ...
                {archive.length === 0 ? (
                  <p className="text-sm text-stone-500 italic">
                    Earlier reports will appear here as they are published.
                  </p>
                ) : (
