...
const DESCRIPTION =
  `Buying in Laurelwood: what to know about this competitive Studio City market, from inventory and pricing to the local edge ${siteConfig.legalName} brings buyers.`;
